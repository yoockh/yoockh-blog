...
const experiences: Experience[] = [
  {
    ...
    description:
      'Resolved 24 tickets across 22 merged PRs in a live production Django/DRF codebase, trusted as the sole intern contributor on the core-api alongside senior engineers. Reduced P99 latency on key endpoints by up to 99.99% through N+1 query elimination, proper scoping, and indexing. Traced and fixed a silent ROI fee corruption bug, delivered auto-generated ROI certificates, funeral director collaboration flow, and email bounce notification system.',
    initial: 'C',
